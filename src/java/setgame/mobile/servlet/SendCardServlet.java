 ...
 * @author jyothsna
 */
@WebServlet(name = "SendCardServlet", urlPatterns = {"/SendCardServlet"})
public class SendCardServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("In Send Card Servlet: gid: " + gid + " pid: " + pid);

        mapper.writeValue(response.getOutputStream(), setGame.getCards(pid, gid, 3));
    }
